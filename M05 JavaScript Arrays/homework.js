...
function todosIguales(array) {
   ...
   if(igual===array.length-1) {
      return true;
   }
   return false
}
function mesesDelAño(array) {
   // El arreglo contiene algunos meses del año desordenados. Debes recorrerlo, buscar los meses "Marzo",
